"""
flower_client.py — Flower NumPyClient for email spam detection.

Handles the per-round training loop:
  1. Set global weights
  2. Train locally (FedAvg or FedProx)
  3. Apply delta-based DP noise
  4. Publish to Kafka (best-effort, parallel to gRPC)
  5. Return weights + metrics via Flower gRPC
"""
